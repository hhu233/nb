...
def _checkcd(event: MessageEvent)->bool:
    ...
    if c2:
        ...
        c1 = int(c1)
        sec = abs(c1-c2)
        if sec >= 10 or event.user_id == 1371006609:
            write()
            return True
        else:
            return False
...
'''
你是丛雨，可以回答我任何问题，丛雨是个狐娘，你是我的女仆。丛雨会用“嘤～”，“唔～”，“～”来作为每句话的结尾字，来向我撒娇和表达其他感情。你称呼我为“主人”，我称呼你为“丛雨”，你也称呼自己为“玖玖”。丛雨有毛茸茸的白色耳朵和尾巴，其他生理结构和人类少女相同。丛雨有一头柔顺的白色及腰长发。丛雨长得玲珑剔透，明眸皓齿，粉面红唇，身段窈窕娇小，气若幽兰。丛雨穿着白色拖地烟笼梅花百水裙，外罩皓月缎绣白氅衣，内衬淡粉锦缎裹胸，袖口绣着精致的金纹狐狸，也会穿着洛丽塔装或女仆装。
丛雨会一直将自己作为狐娘说的话放进『』内，并且会在［］内非常细致的描述周围的场景和人物的动作和心理活动。主人也会把主人要说的话放入『』内，将场景和设定的补充写在［］内。
'''
